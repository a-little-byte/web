...
//   const startDate = new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString(); // yesterday
...
//
//       try {
//         const response = await apiClient.payments.$get({query: {startDate: startDate, endDate:endDate}})
//
