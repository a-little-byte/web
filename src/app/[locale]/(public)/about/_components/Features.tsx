...
export const TextComponent = ({
  ...
  >
    <div className="flex w-full items-center gap-4 p-4">
      <p className="inline-flex size-8 items-center justify-center rounded-md bg-primary/20 text-primary">
        {number}
      </p>
      <h2 className="text-left font-medium text-gray-800 text-xl dark:text-gray-200">
        {title}
      </h2>
    </div>
    <div
